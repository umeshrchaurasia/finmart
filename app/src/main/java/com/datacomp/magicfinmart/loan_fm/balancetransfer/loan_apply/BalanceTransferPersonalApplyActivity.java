...
public class BalanceTransferPersonalApplyActivity extends BaseActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, IResponseSubcriber, magicfinmart.datacomp.com.finmartserviceapi.finmart.IResponseSubcriber, IResponseSubcriberERP {
    ...
    private void setEmpSalaried(String Type, boolean flag, TextView clickedText, TextView textView1) {
        ...
        clickedText.setTextColor(ContextCompat.getColor(BalanceTransferPersonalApplyActivity.this, Utility.getPrimaryColor(this)));
...
//            Toast.makeText(this,result,Toast.LENGTH_SHORT).show();
        ...
        new TrackingController(this).sendData(new TrackingRequestEntity(new TrackingData("Balance Transfer Personal LOAN : Application Save"), Constants.BALANCE_TRANSFER), null);

        MyApplication.getInstance().trackEvent( Constants.BALANCE_TRANSFER,"Clicked","Balance Transfer Personal LOAN : Application Save");
