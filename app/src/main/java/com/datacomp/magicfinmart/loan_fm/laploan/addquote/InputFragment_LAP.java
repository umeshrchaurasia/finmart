 ...
 */
 ...
 public class InputFragment_LAP extends BaseFragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, TextWatcher {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments() != null) {
            if (getArguments().getParcelable(LAPMainActivity.HL_INPUT_REQUEST) != null) {
                fmHomeLoanRequest = getArguments().getParcelable(LAPMainActivity.HL_INPUT_REQUEST);
